...
namespace ZAI
{
    ...
    public sealed class AutoSDKConditionalResponse<T>
    {
        internal AutoSDKConditionalResponse(
            bool notModified,
            string? entityTag,
            global::ZAI.AutoSDKHttpResponse<T>? response)
        {
        ...
        public global::ZAI.AutoSDKHttpResponse<T>? Response { get; }
    }
    ...
    public static class AutoSDKConditionalRequests
    {
        ...
        /// </summary>
        public static async global::System.Threading.Tasks.Task<global::ZAI.AutoSDKConditionalResponse<T>> SendAsync<T>(
            global::System.Func<global::ZAI.AutoSDKRequestOptions, global::System.Threading.CancellationToken, global::System.Threading.Tasks.Task<global::ZAI.AutoSDKHttpResponse<T>>> send,
            string? entityTag = null,
            global::ZAI.AutoSDKRequestOptions? requestOptions = null,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new global::ZAI.AutoSDKConditionalResponse<T>(
                    notModified: false,
                    entityTag: GetEntityTag(response.Headers),
                    response: response);
            }
            catch (global::ZAI.ApiException exception)
        ...
        private static global::ZAI.AutoSDKRequestOptions CloneRequestOptions(
            global::ZAI.AutoSDKRequestOptions? source)
        {
            var clone = new global::ZAI.AutoSDKRequestOptions();
            if (source == null)
            {
                return clone;
            }
