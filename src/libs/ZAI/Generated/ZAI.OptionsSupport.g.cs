...
namespace ZAI
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::ZAI.AutoSDKRetryOptions Retry { get; set; } = new global::ZAI.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::ZAI.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::ZAI.IAutoSDKHook>();
        ...
        public global::ZAI.AutoSDKClientOptions AddHook(
            global::ZAI.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::ZAI.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::ZAI.AutoSDKClientOptions UseAuthorizationProvider(
            global::ZAI.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::ZAI.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::ZAI.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::ZAI.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::ZAI.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::ZAI.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::ZAI.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::ZAI.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::ZAI.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::ZAI.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::ZAI.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::ZAI.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::ZAI.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::ZAI.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::ZAI.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::ZAI.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::ZAI.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::ZAI.AutoSDKClientOptions clientOptions,
            global::ZAI.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::ZAI.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::ZAI.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::ZAI.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::ZAI.AutoSDKClientOptions clientOptions,
            global::System.Func<global::ZAI.IAutoSDKHook, global::ZAI.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::ZAI.AutoSDKHookContext context)
        {
