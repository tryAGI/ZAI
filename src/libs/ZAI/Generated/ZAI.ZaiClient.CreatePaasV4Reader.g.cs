                    ...
                    await global::ZAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::ZAI.ReaderResponse.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::ZAI.ReaderResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
